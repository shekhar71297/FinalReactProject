...
//         return (
//             <div>
//                 <Button variant="contained" color="primary" size="small" type="button" onClick={() => (this.handleOpen(true))}><AddIcon/>Exam</Button>
//                 &nbsp;&nbsp;&nbsp;&nbsp;
//             </div>
//         )
//     }
...
// import { Dialog, DialogTitle, DialogContent, DialogC…
// [1:22 pm, 11/08/2023] Vishakha Mankar: Yaar Bhai possible hoeil title lavkar kar share ma
// [3:22 pm, 11/08/2023] Vishakha Mankar: 9552112446
// Kumbhar mavshi (gauri)
// [9:01 pm, 11/08/2023] Vishakha Mankar: import React, { Component } from 'react'
...
//   handleSubmit = () => {
//     const { examName, examDate } = this.state;
...
//   render() {
//     const { open, examName, examDate } = this.state;
